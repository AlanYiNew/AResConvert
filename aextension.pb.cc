...
const ::_pbi::DescriptorTable descriptor_table_aextension_2eproto = {
    ...
    nullptr, file_level_enum_descriptors_aextension_2eproto,
    file_level_service_descriptors_aextension_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_aextension_2eproto_getter() {
  return &descriptor_table_aextension_2eproto;
}
...
const std::string col_name_default("");
